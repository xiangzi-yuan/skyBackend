...
public final class MessageConstant {
    ...
    public static final String ADDRESS_BOOK_ID_REQUIRED = "addressBookId is required";
    public static final String ADDRESS_BOOK_NOT_FOUND = "地址不存在";
    public static final String DEFAULT_ADDRESS_NOT_FOUND = "默认地址不存在";
    public static final String ADDRESS_BOOK_NOT_BELONG_TO_USER = "地址不存在或无权限";
    ...
    public static final String TABLEWARE_STATUS_INVALID = "餐具数量状态不合法";
    public static final String TABLEWARE_NUMBER_REQUIRED = "请选择餐具数量";
    public static final String TABLEWARE_NUMBER_INVALID = "餐具数量不合法";
    public static final String PACK_AMOUNT_REQUIRED = "packAmount is required";
    public static final String PACK_AMOUNT_INVALID = "打包费不合法";
